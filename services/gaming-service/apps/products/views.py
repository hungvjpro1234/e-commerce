...
from apps.products.models import GamingProduct
from apps.products.serializers import (
    GamingProductSerializer,
...
class ProductViewSet(viewsets.ModelViewSet):
    serializer_class = GamingProductSerializer
    queryset = GamingProduct.objects.all()
        ...
        return Response(
            {
                ...
                "product": GamingProductSerializer(product).data,
            }
        )
