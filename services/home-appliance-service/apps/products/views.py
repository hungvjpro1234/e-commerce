...
from apps.products.serializers import (
    HomeApplianceProductSerializer,
...
class ProductViewSet(viewsets.ModelViewSet):
    serializer_class = HomeApplianceProductSerializer
    queryset = HomeApplianceProduct.objects.all()
        ...
        return Response(
            {
                ...
                "product": HomeApplianceProductSerializer(product).data,
            }
        )
