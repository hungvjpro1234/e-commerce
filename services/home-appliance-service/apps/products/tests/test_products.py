...
class HomeApplianceProductTests(APITestCase):
    def setUp(self):
    ...
    def test_public_can_list_products(self):
        response = self.client.get("/api/home-appliance-products")
    ...
    def test_staff_token_can_create_product(self):
        ...
        self.assertEqual(HomeApplianceProduct.objects.count(), 1)
