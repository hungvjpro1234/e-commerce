...
from apps.products.models import BeautyProduct
from shared.common.auth import build_jwt_payload, encode_token


class BeautyProductTests(APITestCase):
    def setUp(self):
    ...
    def test_public_can_list_products(self):
        response = self.client.get("/api/beauty-products")
    ...
    def test_staff_token_can_create_product(self):
        ...
        self.assertEqual(BeautyProduct.objects.count(), 1)
