...
from apps.products.models import BookProduct
from shared.common.auth import build_jwt_payload, encode_token


class BookProductTests(APITestCase):
    def setUp(self):
    ...
    def test_public_can_list_products(self):
        response = self.client.get("/api/book-products")
    ...
    def test_staff_token_can_create_product(self):
        ...
        self.assertEqual(BookProduct.objects.count(), 1)
